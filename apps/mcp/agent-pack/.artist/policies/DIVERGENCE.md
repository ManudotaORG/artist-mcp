...
untidy, but because the tool can answer from either one. Answer from the scratch
page today and the tidy page next week and the two drift further apart with
every session, each answer correct against the page it read and wrong about the
gig. The musician then maintains two pages for one event, which is the opposite
of unloading project management.

Detecting this matters less than what follows it. The damage is done after the
twin is known, by working in one page as though the other were not there.
...
These hold from the moment it is suspected, not from when it is confirmed.
