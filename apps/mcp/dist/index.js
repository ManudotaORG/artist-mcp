...
import { copyWorkflowForEditing, installAgentPack, runAgentsStatus, setLocalAgentRoot, } from './agents.js';
        ...
        case 'agents':
            switch (argv[1]) {
                ...
                case 'status':
                    ...
                    break;
                default:
                    throw new Error('Usage: artist-mcp agents <install [directory]|edit <id> <directory>|status>');
            }
            break;
        default:
