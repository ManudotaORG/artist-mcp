...
How this project was built: the original MVP checklist, the architecture as it
stood at 1.0.0, and the acceptance record. **Nothing here describes the system
as it is today** — several sections describe components that have since been
removed. It is kept because the reasoning is often still useful and because a
ticked box is evidence of what was actually verified, and when.

For what is true now, see [scope.md](scope.md), [development.md](development.md)
and [operations.md](operations.md).

## How to use this document

> This section described how to work *through* the checklist while it was live.
> It is finished. Do not tick, edit or add boxes here — record current work in
> [scope.md](scope.md) instead. The rules are kept because they explain what a
> tick below is worth.
